...
# 27/03/2012 15:44:43, [INFO]  Return code for program [LK1000] is [0], LK1000, 23112
    ...
    def __init__(self, ecl):
        ...
        if self.status != 0:
            print 'Command:', ecl, 'exit with code:', self.status

#        print self.filename, 'started...'
        # find output file in stdout
        print ecl
        self.etime = time.time() - self.t0
        self.file = re.search('REDIRECTING  DEFAULT  OUTPUT  TO: (.*)', self.output)
#        print self.output
        ...
        self.fh = open(self.file.group(1), 'r')
...
#            print 'filename:', filename
    ...
    for ecl in ecls:
        print ecl.get_filename(), 'got:', ecl.result(), 'time:',
